...
public class RestClusterPutWRRWeightsAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return singletonList(new Route(PUT, "/_cluster/shard_routing/weights"));
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> client.admin()
            .cluster()
            .putWRRWeights(putWRRWeightsRequest, new RestToXContentListener<>(channel));
    }
    ...
    public static ClusterPutWRRWeightsRequest createRequest(RestRequest request) throws IOException {
        ...
        request.applyContentParser(p -> putWRRWeightsRequest.source(p.mapOrdered()));
