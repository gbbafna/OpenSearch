...
public class ClusterGetWRRWeightsRequestBuilder extends ClusterManagerNodeReadOperationRequestBuilder<
    ...
    public ClusterGetWRRWeightsRequestBuilder(OpenSearchClient client, ClusterGetWRRWeightsAction action, List<WRRWeight> weights) {
        super(client, action, new ClusterGetWRRWeightsRequest(weights));
    }
