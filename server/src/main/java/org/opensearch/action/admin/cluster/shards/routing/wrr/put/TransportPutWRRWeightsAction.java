 ...
 * @opensearch.internal
 */
public class TransportPutWRRWeightsAction extends TransportClusterManagerNodeAction<ClusterPutWRRWeightsRequest, ClusterPutWRRWeightsResponse> {

    private static final Logger logger = LogManager.getLogger(TransportPutWRRWeightsAction.class);
    ...
    @Override
    protected void masterOperation(ClusterPutWRRWeightsRequest request, ClusterState state,
                                   ActionListener<ClusterPutWRRWeightsResponse> listener) throws Exception {
