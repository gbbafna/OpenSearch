...
public class MasterTaskThrottler extends Throttler<String> {
    ...
    public void validateSetting(final Settings settings) {
         ...
         */
        if(masterService.state().nodes().getMinNodeVersion().compareTo(V_2_1_0) < 0) {
            throw new IllegalArgumentException("All the nodes in cluster should be on version later than 2.1.0");
        }
