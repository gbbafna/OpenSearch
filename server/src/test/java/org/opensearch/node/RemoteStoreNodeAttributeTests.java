...
public class RemoteStoreNodeAttributeTests  extends OpenSearchTestCase {
    ...
    public void testCryptoMetadata() throws UnknownHostException {
        Map<String, String> attr = Map.of(
            "remote_store.segment.repository" , "remote-store-A",
            "remote_store.translog.repository" , "remote-store-A",
            "remote_store.repository.remote-store-A.type" , "s3",
            "remote_store.repository.remote-store-A.settings.bucket" , "abc",
            "remote_store.repository.remote-store-A.settings.base_path" , "xyz",
            "remote_store.repository.remote-store-A.crypto_metadata.key_provider_name" , "store-test",
            "remote_store.repository.remote-store-A.crypto_metadata.key_provider_type" , "aws-kms",
            "remote_store.repository.remote-store-A.crypto_metadata.settings.region" ,REGION ,
            "remote_store.repository.remote-store-A.crypto_metadata.settings.key_arn" , KEY_ARN
            );
